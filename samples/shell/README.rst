...
.. include:: ../../../docs/includes/device_table_shell.txt
...
If the sample is built for `nrf52840dongle_nrf52840 <nrf52840dongle_>`_, the nRF USB CDC ACM is the default backend for shell.
