...
You can use this Light switch sample to change the state of light sources on other devices within the same Zigbee network.
...
.. code-block:: console
   ...
   west build samples/light_switch -b nrf52840dk/nrf52840 -- -DEXTRA_CONF_FILE='overlay-multiprotocol_ble.conf'


For the board name to use instead of the ``nrf52840dk/nrf52840``, see `Programming board names`_.

See `Providing CMake options`_ for instructions on how to add flags to your build.
