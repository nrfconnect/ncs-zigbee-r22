...
This single-chip solution has a combined RFIC (the IEEE 802.15.4 in case of Zigbee) and processor.
...
.. include:: /includes/device_table_multi.txt
...
.. include:: /includes/device_table_archi.txt
